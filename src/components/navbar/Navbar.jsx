...
import './Navbar.css'; // Ensure the CSS is imported

function CustomNavbar() {
  return (
    <Navbar expand="lg" className="custom-navbars">
      <Container>
        ...
        <svg
            ...
            role="presentation"
            aria-hidden="true"
            className="h-20 w-auto md:h-20 md:w-66 object-contain">
            <g>
              <g opacity=".86">
                <path
                  strokeWidth=".5"
    ...
    <text
        ...
        <Navbar.Collapse id="navbar-nav">
          <Nav className="ms-auto ">
            ...
            <Nav.Link href="#waitlist" className="waitlist">Join Waitlist</Nav.Link>
